    ...
    try {
      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (xp > 100000) m.reply('Wah, Exp Kamu Melebihi Yang Lain! Cheat?') // Hehehe
          else m.exp += xp
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: '_*[ ❗ ] Hanya Pemilik MechaBots*_',
    owner: '_*[ ❗ ] Hanya Pemilik MechaBots*_',
    mods: '_*[ ❗ ] Hanya Moderator MechaBots*_',
    premium: '_*[ ❗ ] Hanya Pengguna Premium MechaBots*_',
    group: '_*[ ❗ ] Hanya Untuk Grup*_',
    private: '_*[ ❗ ] Hanya Untuk Chat Pribadi*_',
    admin: '_*[ ❗ ] Hanya Untuk Admin Grup*_',
    botAdmin: '_*[ ❗ ] Mechabots Belum Menjadi Admin Grup Ini, Tolong Jadikan Mechabots Sebagai Admin Agar Dapat Menggunakan Perintah Ini*_',
    unreg: '_*Silahkan Daftar Terlebih Dahulu Dengan:\n\n !daftar nama.umur*_\n*HARAP PERGUNAKAN NAMA DAN USIA ASLI AGAR PENGGUNA LAIN DAPAT MENGENAL KAMU*',
    nsfw: '_*[ ❗ ] Mode NSFW Belum Diaktifkan*_\n _*Ingat Dosa Tanggung Sendiri :v*_',
  }[type]
